...
| `heading` | `heading` | The title / heading of the modal. Note that "title" isnt used as a prop name here as "title" is a native html prop which we do not want to overwrite | `string`  | `undefined` |
...
graph TD;
  fx-modal --> fx-button
  style fx-modal fill:#f9f,stroke:#333,stroke-width:4px
```
